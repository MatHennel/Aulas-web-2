...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            <a href="{{ route('redirecionamento') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrar</a>
        ...
        <div class="max-w-7xl p-6 lg:p-8">
            ...
            <h1 class="text-white h-5 font-semibold">Bem vindo a DevEConnection</h1>
