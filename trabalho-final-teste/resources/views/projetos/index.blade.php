<x-app-layout>
    <x-slot name="header">
        ...
        font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:border-indigo-700 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150" href="{{ route('projetos.create') }}">
                    Criar Projeto</a>
            </h2>
                    ...
                    <div class="grid gap-4">
                        <div class="col-span-2 sm:col-span-1">
                            <div class="p-4 flex justify-between items-center w-full">
                                ...
                                <div class="flex justify-between items-center w-200">
                                    <a href="{{ route('projetos.edit', $projeto) }}" class="mr-5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="cyan" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            ...
                            <div class="p-4 flex justify-between w-full">
                                ...
                                <div>
                                    Data Prevista Para Entrega: {{ \Carbon\Carbon::createFromFormat('Y-m-d', $projeto->dataEntrega)->locale('pt')->isoFormat('DD [de] MMMM [de] YYYY') }}
